        ...
        <div className="max-w-[1160px] my-0 mx-auto py-0 ">
          ...
          <header className="mb-[30px] items-baseline flex-row m-0 flex flex-wrap content-between">
            <span className="relative inline-block">
              ...
              >
                <h2 className="inline-block">All community posts </h2>
                <svg
              ...
              {show2 && (
                <span className="block bg-[#fff] border-[1px] border-solid border-[#d8d8d8] text-[14px] rounded left-0 mt-[1px] min-w-[170px] py-[10px] px-0 absolute text-left z-50">
                  ...
                  <Link
                    ...
                    className=" cursor-pointer block text-[#333] py-[7px] px-[15px] hover:bg-slate-100"
                  >
                    <p className="inline-block">Show all posts</p>
                    <svg
          ...
          <div className="pb-[10px] border-b-[1px] border-b-solid border-b-[#ddd] text-[13px]">
            <span className="">
              <span className="bt-0 inline-block mr-[20px] p-0 relative">
                <button className="m-[20px] cursor-pointer inline-block p-0 text-[#5865F2]" onClick={handleClick3}>
                  Show All
                  <svg
                    className="inline-block ml-[10px]"
                    width="12px"
                    ...
                    fill="#5865F2"
                  >
                    <path d="M3 4.5l2.6 2.6c.2.2.5.2.7 0L9 4.5"></path>
                  </svg>
                </button>
                {show3 && (<span className="block bg-[#fff] border-[1px] border-solid border-[#d8d8d8] text-[14px] rounded left-0 mt-[1px] min-w-[170px] py-[10px] px-0 absolute text-left z-50">
                  <Link
                    to={"/CommunityPost"}
                    className=" cursor-pointer block text-[#333] py-[7px] px-[15px] hover:bg-slate-100"
                  >
                  ...
                  <Link
                    ...
                    className=" cursor-pointer block text-[#333] py-[7px] px-[15px] hover:bg-slate-100"
                  >
                    <p className="inline-block">Planned</p>
                  </Link>
                  ...
                  <Link
                    ...
                    className=" cursor-pointer block text-[#333] py-[7px] px-[15px] hover:bg-slate-100"
                  >
                    <p className="inline-block">Not planned</p>
                  </Link>
                  ...
                  <Link
                    ...
                    className=" cursor-pointer block text-[#333] py-[7px] px-[15px] hover:bg-slate-100"
                  >
                    <p className="inline-block">Answered</p>
                  </Link>
                  ...
                  <Link
                    ...
                    className=" cursor-pointer block text-[#333] py-[7px] px-[15px] hover:bg-slate-100"
                  >
                    <p className="inline-block">No status</p>
                  </Link>
                </span>
                 )}
              </span>
              ...
              <span className="bt-0 inline-block mr-[20px] p-0 relative">
                <button className="m-[20px] cursor-pointer inline-block p-0 text-[#5865F2]" onClick={handleClick4}>
                  Sort by newest post
                  <svg
                    className="inline-block ml-[10px]"
                    width="12px"
                ...
                {show4 && (<span className="block bg-[#fff] border-[1px] border-solid border-[#d8d8d8] text-[14px] rounded left-0 mt-[1px] min-w-[170px] py-[10px] px-0 absolute text-left z-50">
                  <Link
                    to={"/CommunityPost"}
                    className=" cursor-pointer block text-[#333] py-[7px] px-[15px] hover:bg-slate-100"
                  >
                    <p className="inline-block">Newest post</p>
                    <svg
                      className="inline-block ml-[10px]"
                      width="12px"
                      height="12px"
                  ...
                  <Link
                    ...
                    className=" cursor-pointer block text-[#333] py-[7px] px-[15px] hover:bg-slate-100"
                  >
                    <p className="inline-block">Recent activity</p>
                  </Link>
                  ...
                  <Link
                    ...
                    className=" cursor-pointer block text-[#333] py-[7px] px-[15px] hover:bg-slate-100"
                  >
                    <p className="inline-block">Votes</p>
                  </Link>
          ...
          <div className="p-0 block">
            <section className="">
                <div className="center flex-row border-b-[1px] border-b-solid border-b-[#ddd] flex justify-end py-[20px] px-0">
                  <span className="flex-grow-[2] flex-shrink-[1] basis-0 ">
                    <Link to={"https://support.discord.com/hc/en-us/community/posts/8065932675351-Mute-button-in-voice-video-chat"} className="hover:underline text-[#5865F2]">Ownership transfer</Link>
                   <ul className="my-[5px] block list-none text-[#666] text-[13px] font-light"> 
                  ...
                  <div className="text-[#666] text-[13px] font-light flex flex-1 justify-around">
                    <span className="block py-0 px-[5px] text-center">
