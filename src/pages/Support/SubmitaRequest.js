    ...
    <Fragment>
      ...
      <main className="block box-border">
        ...
        <div className="max-w-[1160px] my-0 mx-auto py-0 ">
          ...
          <h1 className="text-[32px]">Submit a request</h1>
          <div className="max-w-[650px] block">
            <form>
              
              <input className="hidden"></input>
              <div className="">
              <label className="my-5 text-[20px]">What can we help you with?</label>
              <select className="mt-5 border-[1px] border-solid border-[#ddd] rounded py-2 pr-[30px] pl-[10px] w-full text-[#555]" onChange={handleChange}>
                <option value="SubmitaRequest">-</option>
                <option value="HelpSupportForm">Help & Support</option>
                <option value="HackedAccountForm">Hacked Account</option>
                <option value="TrustSafetyForm">Trust & Safety</option>
                <option value="BillingForm">Billing</option>
                <option value="CommunityProgramsForm">Community Programs</option>
                <option value="BugReportingForm">Bug Reporting</option>
                <option value="DeveloperSupportForm">Developer Support</option>
                <option value="TranslationErrorsForm">Translation Errors</option>
                <option value="FileDMCAForm">File a DMCA Takedown Request</option>
                <option value="FileTrademarkForm">File a Trademark Complaint</option>
                <option value="NSFWServerForm ">NSFW Server Owner Appeals</option>
                <option value="ContactDiscordForm">Contact Discord Privacy</option>
              </select>
              </div>
            </form>
            <div className="mt-[25px]">
              <label className="block mb-[5px] text-[16px] font-semibold">Your email address</label>
              <input className="border-[1px] border-solid rounded max-w-full box-border p-[10px] w-full border-[#ddd]"></input>
            </div>
            <div className="mt-[25px]">
            <label className="my-5 text-[20px]">Type of question?</label>
              <select className="mt-5 border-[1px] border-solid border-[#ddd] rounded py-2 pr-[30px] pl-[10px] w-full text-[#555]" onChange={handleChange}>
                <option value="SubmitaRequest">-</option>
            ...
            <div className="mt-[25px]">
              <label className="block mb-[5px] text-[16px] font-semibold">Subject</label>
              <input className="border-[1px] border-solid rounded max-w-full box-border p-[10px] w-full border-[#ddd]"></input>
            </div>
            <div className="mt-[25px]">
              <label className="block mb-[5px] text-[16px] font-semibold">Your email address</label>
              <textarea className="border-[1px] border-solid rounded max-w-full box-border p-[10px] w-full min-h-[120px] border-[#ddd]"></textarea>
            </div>
            <div className="mt-[25px]">
              <label className="block mb-[5px] text-[16px] font-semibold">Attachments (optional)</label>
              <input className="border-[1px] border-solid rounded max-w-full box-border p-[10px] w-full border-[#ddd]"></input>
            </div>
            <div className="flex justify-end mt-10 pt-[30px] ">
              <button type="submit" className="bg-[#21262B] font-semibold text-white w-full border-[1px] border-solid rounded">Submit</button>
            </div>
          </div>
