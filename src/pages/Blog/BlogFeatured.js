...
function BlogFeatured() {
  ...
  return (
    <Fragment>
      ...
      <div className="h-[300px] pt-[72px] mb-20 bg-[#404eed] uppercase">
      <h1 className="font-extrabold text-white uppercase text-center text-6xl mt-10">FEATURED </h1>
      </div>
        ...
        <div className="relative block w-auto max-w-[1480px] min-h-[80px] mx-auto px-[40px] object-fill">
         ...
         <div className="flex flex-wrap justify-center mb-32">
            <a className="bg-[#5865f2] text-white rounded-lg py-3 px-6">
                ...
                <svg fill="white" width="12px" height="12px" viewBox="0 0 12 12" className="inline-block ml-2">
