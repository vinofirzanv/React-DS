        ...
        <div className="mt-[56px] mb-[96px] w-full max-w-[1260px] grid box-border grid-cols-12 gap-y-0 gap-x-5 py-0 px-[24px]">
          <div className="col-start-1 col-end-[span_9] mt-0 row-start-1 row-end-auto">
            <div className="text-[#4f5660] text-[16px] leading-[24px]">
              <p className="mb-[16px]">
                If Trust & Safety confirms a violation, the team takes immediate
                steps to mitigate the harm. The following are actions that we
                might take on either users and/or servers:
              </p>
              <ul className="mt-[16px] ml-[1em] list-disc">
                <li>Removing the content</li>
                <li>Warning users to educate them about their violation</li>
                <li>
                  Temporarily banning for a fixed amount of time as a
                  “cool-down” period
                </li>
                <li>
                  Permanently banning users from Discord and making it difficult
                  for them to create another account
                </li>
                <li>Removing a server from Discord</li>
                <li>Disabling a server’s ability to invite new users</li>
              </ul>
              <p className="my-[16px]">
                Discord also works with law enforcement agencies in cases of
                immediate danger and/or self-harm. In particular, we swiftly
                report child abuse material content and the users responsible to
...
export default WhatActionweTake;
