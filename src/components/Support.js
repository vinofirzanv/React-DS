      ...
      <header className="w-[90%] p-0 max-w-[1160px] mx-auto my-0 relative items-center flex justify-between h-[71px] box-border">
        ...
        <div className="nav-wrapper">
          <nav className="hidden lg:relative lg:inline-block lg:whitespace-nowrap lg:py-0 lg:pl-0 lg:pr-[15px] text-blue-600">
            <a href="feedback.js" className="w-auto py-0 px-[20px] hover:underline">
              {" "}
              Feedback
            </a>
          ...
          <a href="feedback.js" className="text-blue-600  w-auto py-0 px-[20px] hover:underline">
        ...
        <navsecond className={!navbarOpen? "hidden absolute dropdown-menu w-full bg-[#fff]  py-[10px]  px-0  text-center z-[1000] text-black":"lg:hidden"}>
            <a href="feedback.js" className="cursor-pointer py-[7px] pr-[40px] pl-[20px] bg-transparent text-center block">
              {" "}
              Feedback
            </a>
            ...
            <a href="feedback.js" className="cursor-pointer py-[7px] pr-[40px] pl-[20px] bg-transparent block text-center">
              {" "}
              Submit a request
            </a>
        </navsecond>
      ...
      <main className="block">
        <section className="text-center">
          ...
          <p className="text-[16px] font-normal mt-5 mb-[75px]">
            ...
            our{" "}
            <a href="//support.discord.com/hc/articles/360045138571">
              Beginner's Guide
            </a>{" "}
          </p>
        </section>
