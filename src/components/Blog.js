        ...
        <header className="w-full px-10 mx-auto my-0 relative z-[100] items-center flex justify-between h-[84px] box-border ">
          <div className="logo">
            <Link to="/Content" className="px-[10px]">
              <img src={Logo} className="max-h-[37px]"></img>
            </Link>
          </div>
          ...
          <div className="nav-wrapper ">
            <nav className="hidden lg:relative lg:inline-block lg:whitespace-nowrap lg:py-0 lg:pl-0 lg:pr-[15px]  text-white">
              ...
              <a href="feedback.js" className="w-auto py-0 px-[20px]">
                {" "}
                FEATURED
              </a>
      ...
      <div className="my-[100px]">
            ...
            <div className="table content-none mt-[72px] w-full">
              ...
              <div className="w-[67%] relative float-left min-h-[1px] pl-[48px] px-[10px]">
                ...
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4 ">
                      ...
                      <img src={Blogmini1} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover hover:text-[#5865f2]"></img>
              ...
              <div className="table mx-0 w-1/3 float-left" >
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4">
                      <a href="" className="w-full max-w-full inline-block hover:text-[#5865f2] ">
                      <img src={Blogmini2} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover"></img>
              ...
              <div className="table mx-0 w-1/3 float-left" >
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4">
                      <a href="" className="w-full max-w-full inline-block hover:text-[#5865f2] ">
                      <img src={Blogmini4} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover"></img>
                      <div className="text-black font-medium text-[18px] leading-[125%]">
            ...
            <div className="table content-none mt-[72px] w-full">
              ...
              <div className="w-[67%] relative float-left min-h-[1px] pl-[48px] px-[10px]">
                ...
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4">
                      <a href="" className="w-full max-w-full inline-block hover:text-[#5865f2] ">
                      <img src={Blogmini3} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover"></img>
                      <div className="text-black font-medium text-[18px] leading-[125%]">
                      Pride 2022 @ Discord
                      </div>
                      </a>
              ...
              <div className="table mx-0 w-1/3 float-left" >
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4">
                      <a href="" className="w-full max-w-full inline-block hover:text-[#5865f2] ">
                      <img src={community3} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover"></img>
                      <div className="text-black font-medium text-[18px] leading-[125%]">
              ...
              <div className="table mx-0 w-1/3 float-left" >
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4">
                      <a href="" className="w-full max-w-full inline-block hover:text-[#5865f2] ">
                      <img src={community2} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover"></img>
                      <div className="text-black font-medium text-[18px] leading-[125%]">
            ...
            <div className="table content-none mt-[72px] w-full">
              ...
              <div className="w-[67%] relative float-left min-h-[1px] pl-[48px] px-[10px]">
                ...
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4">
                      <a href="" className="w-full max-w-full inline-block hover:text-[#5865f2] ">
                      <img src={re3} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover"></img>
                      <div className="text-black font-medium text-[18px] leading-[125%]">
              ...
              <div className="table mx-0 w-1/3 float-left" >
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4">
                      <a href="" className="w-full max-w-full inline-block hover:text-[#5865f2] ">
                      <img src={re4} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover"></img>
                      <div className="text-black font-medium text-[18px] leading-[125%]">
              ...
              <div className="table mx-0 w-1/3 float-left" >
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4">
                      <a href="" className="w-full max-w-full inline-block hover:text-[#5865f2] ">
                      <img src={re5} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover"></img>
                      <div className="text-black font-medium text-[18px] leading-[125%]">
            ...
            <div className="table content-none mt-[72px] w-full">
              ...
              <div className="w-[67%] relative float-left min-h-[1px] pl-[48px] px-[10px]">
                ...
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4">
                      <a href="" className="w-full max-w-full inline-block hover:text-[#5865f2] ">
                      <img src={ds3} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover"></img>
                      <div className="text-black font-medium text-[18px] leading-[125%]">
              ...
              <div className="table mx-0 w-1/3 float-left" >
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4">
                      <a href="" className="w-full max-w-full inline-block hover:text-[#5865f2] ">
                      <img src={ds4} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover"></img>
                      <div className="text-black font-medium text-[18px] leading-[125%]">
              ...
              <div className="table mx-0 w-1/3 float-left" >
                <div className="w-full px-0 relative float-left min-h-1">
                  <div className="pl-4">
                      <a href="" className="w-full max-w-full inline-block hover:text-[#5865f2] ">
                      <img src={ds5} className="w-full h-[150px] min-h-0 mb-5 rounded-lg object-cover"></img>
                      <div className="text-black font-medium text-[18px] leading-[125%]">
        ...
        <div className="relative block w-auto max-w-[1480px] min-h-[80px] mx-auto px-[40px] object-fill">
          <div className="mt-[80px] p-[40px] rounded-lg bg-[#f6f6f6]">
            <div className="table content-none mt-[72px] w-full">
              <div className="w-[33%] relative float-left min-h-[1px] px-[10px] mt-[24px]">
                <div className=" mb-[8px] font-medium text-[40px]">
                  COLLECTIONS
                </div>
                <div className="overflow-visible text-[#5865f2] text-[40px] leading-[100%] font-black uppercase">
                Engineering & Design
