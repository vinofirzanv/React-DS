...
function DiscordTransparencyReport() {
        ...
        <div className="mt-[56px] mb-[96px] w-full max-w-[1260px] grid box-border grid-cols-12 gap-y-0 gap-x-5 py-0 px-[24px]">
          <div className="col-start-1 col-end-[span_9] mt-0 row-start-1 row-end-auto">
            <div className="text-[#4f5660] text-[16px] leading-[24px]">
              <p className="mb-[16px]">
              You can read our latest Transparency Report <a href="/Blog" className="text-[#00b0f4] hover:underline">
              here
                </a>. It gives more insight into what kind of behavior we’re seeing on Discord, and the actions we took to help keep Discord safe. 
              </p>
              <p className="mb-[16px]">
...
export default DiscordTransparencyReport;
